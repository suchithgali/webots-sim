...
class Metaclass_SpawnNodeFromString_Event(type):
...
class SpawnNodeFromString_Event(metaclass=Metaclass_SpawnNodeFromString_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SpawnNodeFromString_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SpawnNodeFromString_Response'"
...
class SpawnNodeFromString(metaclass=Metaclass_SpawnNodeFromString):
    ...
    from webots_ros2_msgs.srv._spawn_node_from_string import SpawnNodeFromString_Event as Event
