...
class Metaclass_SpawnUrdfRobot_Event(type):
...
class SpawnUrdfRobot_Event(metaclass=Metaclass_SpawnUrdfRobot_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SpawnUrdfRobot_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SpawnUrdfRobot_Response'"
...
class SpawnUrdfRobot(metaclass=Metaclass_SpawnUrdfRobot):
    ...
    from webots_ros2_msgs.srv._spawn_urdf_robot import SpawnUrdfRobot_Event as Event
