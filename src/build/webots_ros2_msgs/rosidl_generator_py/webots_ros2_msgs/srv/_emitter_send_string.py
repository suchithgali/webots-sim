...
class Metaclass_EmitterSendString_Event(type):
...
class EmitterSendString_Event(metaclass=Metaclass_EmitterSendString_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'EmitterSendString_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'EmitterSendString_Response'"
...
class EmitterSendString(metaclass=Metaclass_EmitterSendString):
    ...
    from webots_ros2_msgs.srv._emitter_send_string import EmitterSendString_Event as Event
