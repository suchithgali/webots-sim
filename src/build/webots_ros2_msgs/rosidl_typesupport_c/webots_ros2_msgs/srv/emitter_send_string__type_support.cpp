...
static const _EmitterSendString_Event_type_support_symbol_names_t _EmitterSendString_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_ros2_msgs, srv, EmitterSendString_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, EmitterSendString_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webots_ros2_msgs, srv, EmitterSendString_Event)() {
  return &::webots_ros2_msgs::srv::rosidl_typesupport_c::EmitterSendString_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t EmitterSendString_service_type_support_handle = {
  ...
  &EmitterSendString_Request_message_type_support_handle,
  &EmitterSendString_Response_message_type_support_handle,
  &EmitterSendString_Event_message_type_support_handle,
